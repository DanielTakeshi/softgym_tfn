...
env_arg_dict = {
    'MMOneSphere': dict(
        ...
        render=True,
        headless=True,
        horizon=100,      # If action_repeat=8, use horizon 100 for 800 'inner' steps.
        action_repeat=8,  # Using 1 might make flow calculation easier.
        render_mode='fluid',
        deterministic=False,
        num_variations=1000,
    ...
    'PourWater6D': {'observation_mode': 'cam_rgb',
                  'action_mode': 'rotation_bottom',
                  'render_mode': 'fluid',
                  'deterministic': False,
                  'render': True,
...
SOFTGYM_ENVS = OrderedDict({
    ...
    'MMOneSphere': MMOneSphereEnv,
    'MMMultiSphere': MMMultiSphereEnv,
    'SpheresLadle': SpheresLadleEnv,
})
