...
python examples/demonstrator.py --env_name PourWater6D \
    --act_mode translation_axis_angle  --camera_name default_camera \
    --num_variations 2000  --save_cached_states  --headless 1
